=== Plugin Name ===
Contributors: rajika4ever
Donate link: http://www.mytrickpages.com/AIPWP
...
= How can I add custom style to the my ad units =
You can use your AD Name as CSS ID, So just goto theme style.css file and add your custom style as a ID.


== Screenshots ==

1. This shows ADs Inside Post in action
2. Shows Setting Options
3. Shows how to add the shortcode in posts/pages
4. Shows the Shortcode attrubute handling
